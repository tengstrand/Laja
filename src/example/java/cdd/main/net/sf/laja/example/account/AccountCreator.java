...
public class AccountCreator implements AccountCreatorMaker {
    ...
    public AccountMutableState asMutableState() {
        ...
        public AccountStringState asStringState(StringConverter stringConverter) {
    ...
    public static class AccountStringBuilder {
        ...
        public SourceAccount asSourceAccount() {
            return new AccountBuilder(state.asMutable()).asSourceAccount();
        }

        public DestinationAccount asDestinationAccount() {
            return new AccountBuilder(state.asMutable()).asDestinationAccount();
        }
