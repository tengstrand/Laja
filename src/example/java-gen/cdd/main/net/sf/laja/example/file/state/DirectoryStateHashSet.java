 ...
 */
public class DirectoryStateHashSet extends HashSet<DirectoryState> implements DirectoryStateSet {
    private Object encapsulator;

    public DirectoryStateHashSet() {
    }

    public DirectoryStateHashSet(int size) {
        super(size);
    }

    public static DirectoryStateSet emptySet() {
        return new DirectoryStateHashSet();
    }
