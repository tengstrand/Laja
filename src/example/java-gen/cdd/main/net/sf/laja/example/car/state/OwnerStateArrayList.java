 ...
 */
public class OwnerStateArrayList extends ArrayList<OwnerState> implements OwnerStateList {
    private Object encapsulator;

    public OwnerStateArrayList() {
    }

    public OwnerStateArrayList(int size) {
        super(size);
    }

    public static OwnerStateList emptyList() {
        return new OwnerStateArrayList();
    }
