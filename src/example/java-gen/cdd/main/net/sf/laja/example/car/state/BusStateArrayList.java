 ...
 */
public class BusStateArrayList extends ArrayList<BusState> implements BusStateList {
    private Object encapsulator;

    public BusStateArrayList() {
    }

    public BusStateArrayList(int size) {
        super(size);
    }

    public static BusStateList emptyList() {
        return new BusStateArrayList();
    }
