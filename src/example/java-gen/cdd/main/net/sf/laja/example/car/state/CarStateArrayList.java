 ...
 */
public class CarStateArrayList extends ArrayList<CarState> implements CarStateList {
    private Object encapsulator;

    public CarStateArrayList() {
    }

    public CarStateArrayList(int size) {
        super(size);
    }

    public static CarStateList emptyList() {
        return new CarStateArrayList();
    }
