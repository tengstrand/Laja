 ...
 */
public class VehicleSizeStateArrayList extends ArrayList<VehicleSizeState> implements VehicleSizeStateList {
    private Object encapsulator;

    public VehicleSizeStateArrayList() {
    }

    public VehicleSizeStateArrayList(int size) {
        super(size);
    }

    public static VehicleSizeStateList emptyList() {
        return new VehicleSizeStateArrayList();
    }
