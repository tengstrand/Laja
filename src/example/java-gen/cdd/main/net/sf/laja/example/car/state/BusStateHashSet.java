 ...
 */
public class BusStateHashSet extends HashSet<BusState> implements BusStateSet {
    private Object encapsulator;

    public BusStateHashSet() {
    }

    public BusStateHashSet(int size) {
        super(size);
    }

    public static BusStateSet emptySet() {
        return new BusStateHashSet();
    }
