 ...
 */
public class CustomerStateArrayList extends ArrayList<CustomerState> implements CustomerStateList {
    private Object encapsulator;

    public CustomerStateArrayList() {
    }

    public CustomerStateArrayList(int size) {
        super(size);
    }

    public static CustomerStateList emptyList() {
        return new CustomerStateArrayList();
    }
