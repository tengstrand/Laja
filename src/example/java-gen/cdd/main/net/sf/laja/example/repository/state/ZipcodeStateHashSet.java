 ...
 */
public class ZipcodeStateHashSet extends HashSet<ZipcodeState> implements ZipcodeStateSet {
    private Object encapsulator;

    public ZipcodeStateHashSet() {
    }

    public ZipcodeStateHashSet(int size) {
        super(size);
    }

    public static ZipcodeStateSet emptySet() {
        return new ZipcodeStateHashSet();
    }
