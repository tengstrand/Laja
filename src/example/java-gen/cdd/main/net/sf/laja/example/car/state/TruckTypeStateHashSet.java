 ...
 */
public class TruckTypeStateHashSet extends HashSet<TruckTypeState> implements TruckTypeStateSet {
    private Object encapsulator;

    public TruckTypeStateHashSet() {
    }

    public TruckTypeStateHashSet(int size) {
        super(size);
    }

    public static TruckTypeStateSet emptySet() {
        return new TruckTypeStateHashSet();
    }
