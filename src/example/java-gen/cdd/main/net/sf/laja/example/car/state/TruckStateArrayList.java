 ...
 */
public class TruckStateArrayList extends ArrayList<TruckState> implements TruckStateList {
    private Object encapsulator;

    public TruckStateArrayList() {
    }

    public TruckStateArrayList(int size) {
        super(size);
    }

    public static TruckStateList emptyList() {
        return new TruckStateArrayList();
    }
