 ...
 */
public class ComputerStateHashSet extends HashSet<ComputerState> implements ComputerStateSet {
    private Object encapsulator;

    public ComputerStateHashSet() {
    }

    public ComputerStateHashSet(int size) {
        super(size);
    }

    public static ComputerStateSet emptySet() {
        return new ComputerStateHashSet();
    }
