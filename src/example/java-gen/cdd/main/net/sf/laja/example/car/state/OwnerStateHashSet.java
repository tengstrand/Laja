 ...
 */
public class OwnerStateHashSet extends HashSet<OwnerState> implements OwnerStateSet {
    private Object encapsulator;

    public OwnerStateHashSet() {
    }

    public OwnerStateHashSet(int size) {
        super(size);
    }

    public static OwnerStateSet emptySet() {
        return new OwnerStateHashSet();
    }
