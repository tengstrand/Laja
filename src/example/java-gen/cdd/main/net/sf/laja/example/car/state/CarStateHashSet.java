 ...
 */
public class CarStateHashSet extends HashSet<CarState> implements CarStateSet {
    private Object encapsulator;

    public CarStateHashSet() {
    }

    public CarStateHashSet(int size) {
        super(size);
    }

    public static CarStateSet emptySet() {
        return new CarStateHashSet();
    }
