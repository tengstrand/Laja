 ...
 */
public class DirectoryStateArrayList extends ArrayList<DirectoryState> implements DirectoryStateList {
    private Object encapsulator;

    public DirectoryStateArrayList() {
    }

    public DirectoryStateArrayList(int size) {
        super(size);
    }

    public static DirectoryStateList emptyList() {
        return new DirectoryStateArrayList();
    }
