 ...
 */
public class VehicleStateArrayList extends ArrayList<VehicleState> implements VehicleStateList {
    private Object encapsulator;

    public VehicleStateArrayList() {
    }

    public VehicleStateArrayList(int size) {
        super(size);
    }

    public static VehicleStateList emptyList() {
        return new VehicleStateArrayList();
    }
