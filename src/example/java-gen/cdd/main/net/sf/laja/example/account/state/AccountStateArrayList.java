 ...
 */
public class AccountStateArrayList extends ArrayList<AccountState> implements AccountStateList {
    private Object encapsulator;

    public AccountStateArrayList() {
    }

    public AccountStateArrayList(int size) {
        super(size);
    }

    public static AccountStateList emptyList() {
        return new AccountStateArrayList();
    }
