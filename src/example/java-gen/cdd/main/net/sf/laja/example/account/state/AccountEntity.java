...
public class AccountEntity {
    ...
    public AccountEntity(AccountState state) {
        this.state = state;
        state.setEncapsulator(this);
    }

    public AccountEntity(AccountState state, AccountStateBuilder stateBuilder) {
        this.state = state;
    ...
    public boolean equals(Object o) {
        ...
        return state.equals(((AccountEntity)o).state);
    }
