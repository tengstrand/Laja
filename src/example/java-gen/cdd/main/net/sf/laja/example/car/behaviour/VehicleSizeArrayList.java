 ...
 *   http://laja.sf.net
 */
public class VehicleSizeArrayList implements VehicleSizeList, RandomAccess, Cloneable, java.io.Serializable {
    ...
    public VehicleSize get(int index) {
    ...
    public ListIterator<VehicleSize> listIterator() {
        return list.listIterator();
    }

    public ListIterator<VehicleSize> listIterator(int index) {
        return list.listIterator(index);
    }

    public List<VehicleSize> subList(int fromIndex, int toIndex) {
