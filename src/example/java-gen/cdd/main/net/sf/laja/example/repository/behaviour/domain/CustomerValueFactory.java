...
public class CustomerValueFactory extends CustomerValue {

    public CustomerValueFactory(CustomerState state) {
        super(state);
    }

    public CustomerValueFactory(CustomerState state, CustomerStateBuilder stateBuilder) {
