 ...
 */
public class FileStateArrayList extends ArrayList<FileState> implements FileStateList {
    private Object encapsulator;

    public FileStateArrayList() {
    }

    public FileStateArrayList(int size) {
        super(size);
    }

    public static FileStateList emptyList() {
        return new FileStateArrayList();
    }
