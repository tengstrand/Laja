 ...
 */
public class VehicleStateHashSet extends HashSet<VehicleState> implements VehicleStateSet {
    private Object encapsulator;

    public VehicleStateHashSet() {
    }

    public VehicleStateHashSet(int size) {
        super(size);
    }

    public static VehicleStateSet emptySet() {
        return new VehicleStateHashSet();
    }
