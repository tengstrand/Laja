...
public class TestCarValueFactory extends CarValue {

    public TestCarValueFactory(CarState state) {
        super(state);
    }

    public TestCarValueFactory(CarState state, CarStateBuilder stateBuilder) {
