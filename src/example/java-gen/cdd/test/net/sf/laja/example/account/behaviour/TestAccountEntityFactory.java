...
public class TestAccountEntityFactory extends AccountEntity {

    public TestAccountEntityFactory(AccountState state) {
        super(state);
    }

    public TestAccountEntityFactory(AccountState state, AccountStateBuilder stateBuilder) {
