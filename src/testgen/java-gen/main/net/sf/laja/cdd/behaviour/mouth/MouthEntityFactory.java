...
public class MouthEntityFactory extends MouthEntity {

    public MouthEntityFactory(MouthState state) {
        super(state);
    }

    public MouthEntityFactory(MouthState state, MouthStateBuilder stateBuilder) {
