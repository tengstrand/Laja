 ...
 */
public class ForeheadStateArrayList extends ArrayList<ForeheadState> implements ForeheadStateList {
    private Object encapsulator;

    public ForeheadStateArrayList() {
    }

    public ForeheadStateArrayList(int size) {
        super(size);
    }

    public static ForeheadStateList emptyList() {
        return new ForeheadStateArrayList();
    }
