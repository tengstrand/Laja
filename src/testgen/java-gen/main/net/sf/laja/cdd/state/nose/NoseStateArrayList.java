 ...
 */
public class NoseStateArrayList extends ArrayList<NoseState> implements NoseStateList {
    private Object encapsulator;

    public NoseStateArrayList() {
    }

    public NoseStateArrayList(int size) {
        super(size);
    }

    public static NoseStateList emptyList() {
        return new NoseStateArrayList();
    }
