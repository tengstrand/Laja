 ...
 */
public class EarStateArrayList extends ArrayList<EarState> implements EarStateList {
    private Object encapsulator;

    public EarStateArrayList() {
    }

    public EarStateArrayList(int size) {
        super(size);
    }

    public static EarStateList emptyList() {
        return new EarStateArrayList();
    }
