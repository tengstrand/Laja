 ...
 */
public class MonsterStateArrayList extends ArrayList<MonsterState> implements MonsterStateList {
    private Object encapsulator;

    public MonsterStateArrayList() {
    }

    public MonsterStateArrayList(int size) {
        super(size);
    }

    public static MonsterStateList emptyList() {
        return new MonsterStateArrayList();
    }
