 ...
 */
public class NailStateHashSet extends HashSet<NailState> implements NailStateSet {
    private Object encapsulator;

    public NailStateHashSet() {
    }

    public NailStateHashSet(int size) {
        super(size);
    }

    public static NailStateSet emptySet() {
        return new NailStateHashSet();
    }
