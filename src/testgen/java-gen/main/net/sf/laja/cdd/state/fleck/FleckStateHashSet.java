 ...
 */
public class FleckStateHashSet extends HashSet<FleckState> implements FleckStateSet {
    private Object encapsulator;

    public FleckStateHashSet() {
    }

    public FleckStateHashSet(int size) {
        super(size);
    }

    public static FleckStateSet emptySet() {
        return new FleckStateHashSet();
    }
