 ...
 */
public class MonsterStateHashSet extends HashSet<MonsterState> implements MonsterStateSet {
    private Object encapsulator;

    public MonsterStateHashSet() {
    }

    public MonsterStateHashSet(int size) {
        super(size);
    }

    public static MonsterStateSet emptySet() {
        return new MonsterStateHashSet();
    }
