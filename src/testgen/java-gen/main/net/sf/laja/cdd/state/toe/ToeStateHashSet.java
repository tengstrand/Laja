 ...
 */
public class ToeStateHashSet extends HashSet<ToeState> implements ToeStateSet {
    private Object encapsulator;

    public ToeStateHashSet() {
    }

    public ToeStateHashSet(int size) {
        super(size);
    }

    public static ToeStateSet emptySet() {
        return new ToeStateHashSet();
    }
