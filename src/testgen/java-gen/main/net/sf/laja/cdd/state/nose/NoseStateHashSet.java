 ...
 */
public class NoseStateHashSet extends HashSet<NoseState> implements NoseStateSet {
    private Object encapsulator;

    public NoseStateHashSet() {
    }

    public NoseStateHashSet(int size) {
        super(size);
    }

    public static NoseStateSet emptySet() {
        return new NoseStateHashSet();
    }
