 ...
 */
public class FleckStateArrayList extends ArrayList<FleckState> implements FleckStateList {
    private Object encapsulator;

    public FleckStateArrayList() {
    }

    public FleckStateArrayList(int size) {
        super(size);
    }

    public static FleckStateList emptyList() {
        return new FleckStateArrayList();
    }
