 ...
 */
public class AnimalStateArrayList extends ArrayList<AnimalState> implements AnimalStateList {
    private Object encapsulator;

    public AnimalStateArrayList() {
    }

    public AnimalStateArrayList(int size) {
        super(size);
    }

    public static AnimalStateList emptyList() {
        return new AnimalStateArrayList();
    }
