 ...
 */
public class XHandStateArrayList extends ArrayList<XHandState> implements XHandStateList {
    private Object encapsulator;

    public XHandStateArrayList() {
    }

    public XHandStateArrayList(int size) {
        super(size);
    }

    public static XHandStateList emptyList() {
        return new XHandStateArrayList();
    }
