 ...
 */
public class EyeStateHashSet extends HashSet<EyeState> implements EyeStateSet {
    private Object encapsulator;

    public EyeStateHashSet() {
    }

    public EyeStateHashSet(int size) {
        super(size);
    }

    public static EyeStateSet emptySet() {
        return new EyeStateHashSet();
    }
