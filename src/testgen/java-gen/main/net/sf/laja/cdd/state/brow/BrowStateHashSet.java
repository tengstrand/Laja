 ...
 */
public class BrowStateHashSet extends HashSet<BrowState> implements BrowStateSet {
    private Object encapsulator;

    public BrowStateHashSet() {
    }

    public BrowStateHashSet(int size) {
        super(size);
    }

    public static BrowStateSet emptySet() {
        return new BrowStateHashSet();
    }
