 ...
 */
public class HeadStateHashSet extends HashSet<HeadState> implements HeadStateSet {
    private Object encapsulator;

    public HeadStateHashSet() {
    }

    public HeadStateHashSet(int size) {
        super(size);
    }

    public static HeadStateSet emptySet() {
        return new HeadStateHashSet();
    }
