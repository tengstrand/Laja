 ...
 */
public class NailStateArrayList extends ArrayList<NailState> implements NailStateList {
    private Object encapsulator;

    public NailStateArrayList() {
    }

    public NailStateArrayList(int size) {
        super(size);
    }

    public static NailStateList emptyList() {
        return new NailStateArrayList();
    }
