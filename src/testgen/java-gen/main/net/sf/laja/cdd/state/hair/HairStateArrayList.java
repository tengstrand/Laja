 ...
 */
public class HairStateArrayList extends ArrayList<HairState> implements HairStateList {
    private Object encapsulator;

    public HairStateArrayList() {
    }

    public HairStateArrayList(int size) {
        super(size);
    }

    public static HairStateList emptyList() {
        return new HairStateArrayList();
    }
