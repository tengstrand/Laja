 ...
 */
public class MouthStateHashSet extends HashSet<MouthState> implements MouthStateSet {
    private Object encapsulator;

    public MouthStateHashSet() {
    }

    public MouthStateHashSet(int size) {
        super(size);
    }

    public static MouthStateSet emptySet() {
        return new MouthStateHashSet();
    }
