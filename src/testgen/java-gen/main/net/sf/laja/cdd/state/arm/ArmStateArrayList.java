 ...
 */
public class ArmStateArrayList extends ArrayList<ArmState> implements ArmStateList {
    private Object encapsulator;

    public ArmStateArrayList() {
    }

    public ArmStateArrayList(int size) {
        super(size);
    }

    public static ArmStateList emptyList() {
        return new ArmStateArrayList();
    }
