 ...
 */
public class LegStateHashSet extends HashSet<LegState> implements LegStateSet {
    private Object encapsulator;

    public LegStateHashSet() {
    }

    public LegStateHashSet(int size) {
        super(size);
    }

    public static LegStateSet emptySet() {
        return new LegStateHashSet();
    }
