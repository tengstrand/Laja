 ...
 */
public class FingerStateHashSet extends HashSet<FingerState> implements FingerStateSet {
    private Object encapsulator;

    public FingerStateHashSet() {
    }

    public FingerStateHashSet(int size) {
        super(size);
    }

    public static FingerStateSet emptySet() {
        return new FingerStateHashSet();
    }
