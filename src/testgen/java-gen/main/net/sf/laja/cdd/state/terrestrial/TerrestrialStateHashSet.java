 ...
 */
public class TerrestrialStateHashSet extends HashSet<TerrestrialState> implements TerrestrialStateSet {
    private Object encapsulator;

    public TerrestrialStateHashSet() {
    }

    public TerrestrialStateHashSet(int size) {
        super(size);
    }

    public static TerrestrialStateSet emptySet() {
        return new TerrestrialStateHashSet();
    }
