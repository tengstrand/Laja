 ...
 */
public class LegStateArrayList extends ArrayList<LegState> implements LegStateList {
    private Object encapsulator;

    public LegStateArrayList() {
    }

    public LegStateArrayList(int size) {
        super(size);
    }

    public static LegStateList emptyList() {
        return new LegStateArrayList();
    }
