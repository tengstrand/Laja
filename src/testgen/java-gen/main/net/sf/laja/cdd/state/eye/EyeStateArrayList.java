 ...
 */
public class EyeStateArrayList extends ArrayList<EyeState> implements EyeStateList {
    private Object encapsulator;

    public EyeStateArrayList() {
    }

    public EyeStateArrayList(int size) {
        super(size);
    }

    public static EyeStateList emptyList() {
        return new EyeStateArrayList();
    }
