 ...
 */
public class HairStateHashSet extends HashSet<HairState> implements HairStateSet {
    private Object encapsulator;

    public HairStateHashSet() {
    }

    public HairStateHashSet(int size) {
        super(size);
    }

    public static HairStateSet emptySet() {
        return new HairStateHashSet();
    }
