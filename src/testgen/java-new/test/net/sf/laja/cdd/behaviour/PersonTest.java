...
import static net.sf.laja.cdd.state.AddressState.IllegalAddressStateStreetNameIsNullException;
...
public class PersonTest {
    ...
    @Test(expected = IllegalAddressStateStreetNameIsNullException.class)
