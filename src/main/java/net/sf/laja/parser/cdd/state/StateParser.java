...
public final class StateParser implements net.sf.laja.parser.engine2.Parser {
    ...
    private net.sf.laja.parser.engine2.element.Element getGrammar2() {
        ...
        state.add(369, s);
        state.add(370, packagestatement);
        state.add(371, s);
        state.add(372, imports, stateStateImports);
        state.add(373, s);
        state.add(374, classStatement, stateStateClassStatement);
        state.add(375, s);
    ...
    private net.sf.laja.parser.engine2.element.Element getGrammar1() {
        ...
        state.add(370, packagestatement);
        state.add(371, s);
        state.add(372, imports);
        state.add(373, s);
        state.add(374, classStatement);
        state.add(375, s);
